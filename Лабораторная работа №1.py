...
print("Он поможет вам перевести значение из одной единицы в другую.\n")
...
while True:
    ...
    if choice == "5":
        print("Выход из программы. Хорошего Вам дня!")
        break
    ...
    if choice == "1":
        ...
        print("Такого варианта нет, попробуйте пожалуйста снова.\n")